    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capability', models.CharField(choices=[('entry_management', 'Entry Management'), ('scheduling', 'Scheduling'), ('score_management', 'Score Management')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('organizer', 'Organizer'), ('assistant', 'Assistant')], max_length=20)),
                ('is_active', models.BooleanField(default=True)),
